...
public class Causes extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        csmoking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (obesity.getVisibility() == View.VISIBLE)
                    obesity.setVisibility(View.GONE);
        ...
        calcohol.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (obesity.getVisibility() == View.VISIBLE)
                    obesity.setVisibility(View.GONE);
        ...
        cdiet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (obesity.getVisibility() == View.VISIBLE)
                    obesity.setVisibility(View.GONE);
        ...
        cpollution.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (obesity.getVisibility() == View.VISIBLE)
                    obesity.setVisibility(View.GONE);
        ...
        chpv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (obesity.getVisibility() == View.VISIBLE)
                    obesity.setVisibility(View.GONE);
        ...
        cgenes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (obesity.getVisibility() == View.VISIBLE)
                    obesity.setVisibility(View.GONE);
