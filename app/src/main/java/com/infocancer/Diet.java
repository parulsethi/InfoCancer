...
public class Diet extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tomato.setText("This juicy fruit is the best dietary source of lycopene, a carotenoid that gives tomatoes their red hue, Beliveau says. And that's good news, because lycopene was found to stop endometrial cancer cell growth in a study inNutrition and Cancer. Endometrial cancer causes nearly 8,000 deaths a year. \n" + "\n" + "Helps fight: endometrial, lung, prostate, and stomach cancers \n");
